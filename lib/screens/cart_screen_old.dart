...
import 'package:fashion_store/widgets/cart_item_tile.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('Bag items: 2')),
            ),
          ),
        ],
      ),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: const [
                          ...
                          Text('Complimentary', style: TextStyle(fontSize: 14)),
                        ],
                      ),
                      const SizedBox(height: 12),
                      Row(
                      ...
                      Row(
                        ...
                        children: const [
                          Icon(Icons.lock, size: 12, color: AppTheme.grey),
                          SizedBox(width: 8),
                          Text(
                            'Secure Checkout',
                            style: TextStyle(
